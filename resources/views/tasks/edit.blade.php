            ...
            <div class="bg-zinc-900 border border-zinc-800 p-8 rounded-xl">
                <form method="POST" action="{{ route('tasks.update', $task) }}" class="space-y-6">
                    ...
                    <div>
                        ...
                        <x-text-input id="title" class="block w-full bg-black border-zinc-800 text-white focus:border-zinc-500 focus:ring-0 rounded-md p-3 transition-none" type="text" name="title" :value="old('title', $task->title)" required autofocus />
                    ...
                    <div>
                        ...
                        <textarea id="description" name="description" class="block w-full bg-black border-zinc-800 text-white focus:border-zinc-500 focus:ring-0 rounded-md p-3 transition-none" rows="4">{{ old('description', $task->description) }}</textarea>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <select id="status" name="status" class="block w-full bg-black border-zinc-800 text-white focus:border-zinc-500 focus:ring-0 rounded-md p-3 transition-none">
