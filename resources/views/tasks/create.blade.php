            ...
            <div class="bg-zinc-900 border border-zinc-800 p-8 rounded-xl">
                <form method="POST" action="{{ route('tasks.store') }}" class="space-y-6">
                    ...
                    <div>
                        ...
                        <x-text-input id="title" class="block w-full bg-zinc-950 border-zinc-800 text-white focus:border-zinc-500 focus:ring-0 rounded-md p-3 transition-none" type="text" name="title" :value="old('title')" required autofocus placeholder="e.g. Monthly Report" />
                    ...
                    <div>
                        ...
                        <textarea id="description" name="description" class="block w-full bg-zinc-950 border-zinc-800 text-white focus:border-zinc-500 focus:ring-0 rounded-md p-3 transition-none" rows="4" placeholder="Enter task details...">{{ old('description') }}</textarea>
